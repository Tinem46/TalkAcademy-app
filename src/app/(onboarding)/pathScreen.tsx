...
//       if (success) {
//         // Cập nhật cache với survey mới
//         try {
//           const cachedSurveys = await AsyncStorage.getItem('allSurveys');
//           if (cachedSurveys) {
//             const surveys = JSON.parse(cachedSurveys);
//             if (Array.isArray(surveys)) {
//               surveys.push(completeSurveyData);
//               await AsyncStorage.setItem('allSurveys', JSON.stringify(surveys));
//               console.log('✅ Updated survey cache with new survey');
//             }
//           }
//         } catch (cacheError) {
//           console.log('⚠️ Could not update survey cache:', cacheError);
//         }
